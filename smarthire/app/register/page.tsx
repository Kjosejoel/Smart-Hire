...
export default function RegisterPage() {
  ...
  const lockedRole = ['seeker', 'recruiter'].includes(searchParams.get('role') ?? '') ? searchParams.get('role') : null
        ...
        <div className="w-full max-w-sm relative z-10">
          ...
          <div className="mb-8">
            ...
            <h2 className="text-3xl font-light text-zinc-100 tracking-tight">
              Create your <span className="italic text-white">account</span>
            </h2>
          </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                {[
                  ...
                  <button
                    ...
                    disabled={lockedRole !== null && lockedRole !== value}
                    className={`flex items-center gap-2.5 px-4 py-3 rounded-lg border text-sm transition-all ${formData.role === value
                        ? 'border-amber-500/60 bg-amber-500/10 text-amber-400'
                        : lockedRole !== null && lockedRole !== value
                          ? 'border-zinc-800/50 bg-zinc-900/30 text-zinc-700 cursor-not-allowed'
