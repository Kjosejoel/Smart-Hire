      ...
      <div className="flex items-center justify-center px-6 py-16 bg-zinc-950 relative">
        ...
        <div className="w-full max-w-sm relative z-10">
          ...
          <div className="mb-8">
            ...
            <p className="text-xs uppercase tracking-widest text-amber-500 mb-2">Welcome back</p>
            <h2 className="text-3xl font-light text-zinc-100 tracking-tight">
              Sign in to your <span className="italic text-zinc-400">account</span>
            </h2>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <a href="/forgot-password" className="text-xs text-amber-500 hover:text-amber-400 transition-colors">
                  Forgot?
                </a>
              </div>
